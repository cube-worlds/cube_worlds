...
const reward = computed(() => {
    ...
    if (!data || typeof data.last_block_time !== 'number' || data.subsidy == null) {
        return '…'
    }
...
const formattedSupply = computed(() => {
    if (!jettonData.value?.total_supply)
        return '…'
...
async function submitMining() {
    ...
    const payload = btoa(String.fromCharCode(...new Uint8Array(await cell.toBoc())))
    ...
    <div class="mining-container">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="stat">
                    <span>Symbol</span><span>SATOSHI</span>
                </div>
                ...
                <div class="stat">
                    <span>Decimals</span><span>9</span>
                </div>

                <div class="stat">
                    <span>Rights revoked</span><span :title="rights ? 'Will be revoked soon' : ''">{{ rights }}</span>
                </div>
