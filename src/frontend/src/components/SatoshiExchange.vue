...
const userBalanceNum = computed(() =>
  Math.floor(toNumberSafe(userStore.balance)),
)
...
const formattedSatoshiReceived = computed(() =>
  satoshiReceived.value === null
    ? '…'
    : commaSeparatedNumber(satoshiReceived.value),
)
...
<template>
  <div class="trade-page">
    <div class="card">
      <!-- OVERLAY -->
      <div v-if="sending" class="overlay">
        <div class="overlay-content">
          <div class="spinner" />
          <div class="overlay-title">Transaction in progress</div>
          <div class="overlay-sub">Confirm the operation in your wallet</div>
        </div>
      </div>
