...
const captcha_token = parameters.get('token') || ''
...
<iframe id="doom_captcha" src="captcha.html?version=${captcha_version}&countdown=${document.currentScript.getAttribute(
  'countdown',
)}&enemies=${captcha_enemies}&user_id=${user_id}&token=${encodeURIComponent(captcha_token)}" style="position:absolute; left:0; top:0; width:100%; height:100%"></iframe>
</div>`
